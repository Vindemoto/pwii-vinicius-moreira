...
if ($_SERVER['REQUEST_METHOD']==='POST'){
    ...
    if (empty($mensagem)){
        ...
        $erros['mensagem'] = 'A mensagem deve ter mais que 10 caracteres.';
    }

    // Se não houver erros, processa o envio
    if(empty($erros)){
        // Sanitiza antes de usar(ex: Salvar em banco, salvar e-mail, etc)
         ...
         * $corpo        = "Nome: $assunto_limpo, $corpo, $cabecalhos);
         * 
         * Você também pode salvar em um banco de dados usando PDO, 
         */
...
<head>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        .campo input.invalido .campo textarea.ivalid {
            border-color: #d9534f;
        }
        button {
            width: 100%;
